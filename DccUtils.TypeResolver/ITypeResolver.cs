...
public interface ITypeResolver {
    ...
    static abstract Type? Resolve(string formattedTypeName, IDictionary<string, Type>? additionalMapping = null);
    ...
    /// <returns>Возвращает запрошенный тип, если он был найден</returns>
    static abstract Type? Resolve(string formattedTypeName, IEnumerable<Type> additionalTypes);
    ...
    static abstract Type? ResolveByFullName(string formattedFullName, IDictionary<string, Type>? additionalMapping = null);
